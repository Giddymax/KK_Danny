...
const staffHiddenSections = new Set([
    "dashboard",
    "reports",
    "staff",
    "settings"
...
function profitMargin(profit, revenue) {
...
function matchesSearch(query, values) {
    ...
    return values.filter((value)=>value !== null && value !== undefined).some((value)=>String(value).toLowerCase().includes(needle));
}
...
function quoteNumberValue(quote) {
...
function saleItemRowsToCart(items) {
    return (items ?? []).filter((item)=>typeof item?.item_name === "string" && item.item_name.trim()).map((item)=>({
            id: item.id,
            name: item.item_name,
...
function supplierToFields(supplier, categorySuggestions = []) {
    return [
        {
            name: "name",
            label: "Supplier name",
...
function purchaseToFields(purchase, itemSuggestions = [], supplierSuggestions = []) {
    return [
        {
            name: "name",
            label: "Item",
...
function expenseToFields(expense, categorySuggestions = []) {
    return [
        {
            name: "category",
            label: "Category",
...
function quoteToFields(quote, itemSuggestions = []) {
    return [
        {
            name: "customer",
            label: "Customer",
...
function AdminDashboard({ userEmail, userName, userRole, isDemo }) {
    _s();
    ...
    const visibleNavItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[visibleNavItems]": ()=>navForRole(userRole)
    }["AdminDashboard.useMemo[visibleNavItems]"], [
        userRole
    ]);
    const defaultSection = visibleNavItems[0]?.key ?? "pos";
    const [active, setActive] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultSection);
    ...
    const [quoteCustomer, setQuoteCustomer] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [quotePhone, setQuotePhone] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [quoteCart, setQuoteCart] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [quoteEditorOpen, setQuoteEditorOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const filteredInventoryItems = inventoryItems.filter((item)=>matchesSearch(searchQuery, [
            item.name,
            item.category,
            item.supplier,
            item.unit,
    ...
    const filteredSalesRecords = salesRecords.filter((sale)=>matchesSearch(searchQuery, [
            sale.ref,
            sale.customer,
            sale.phone,
            sale.date,
    ...
    const filteredSupplierRecords = supplierRecords.filter((supplier)=>matchesSearch(searchQuery, [
            supplier.name,
            supplier.category,
            supplier.phone,
            supplier.active ? "active" : "inactive"
        ]));
    const filteredPurchaseRecords = purchaseRecords.filter((purchase)=>matchesSearch(searchQuery, [
            purchase.name,
            purchase.category,
            purchase.quantity,
            purchase.unitCost,
    ...
    const filteredExpenseRecords = expenseRecords.filter((expense)=>matchesSearch(searchQuery, [
            expense.category,
            expense.amount,
            expense.method,
            expense.date,
    ...
    const filteredQuoteRecords = quoteRecords.filter((quote)=>matchesSearch(searchQuery, [
            quote.quoteNumber,
            quote.customer,
            quote.phone,
            quote.request,
    ...
    const filteredCustomerRecords = customerRecords.filter((customer)=>matchesSearch(searchQuery, [
            customer.name,
            customer.phone,
            customer.balance,
            customer.visits,
    ...
    const filteredStaffRecords = staffRecords.filter((staff)=>matchesSearch(searchQuery, [
            staff.name,
            staff.email,
            staff.role,
    ...
    const inventoryCategoryOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[inventoryCategoryOptions]": ()=>uniqueSorted(inventoryItems.map({
                "AdminDashboard.useMemo[inventoryCategoryOptions]": (item)=>item.category
            }["AdminDashboard.useMemo[inventoryCategoryOptions]"]))
    }["AdminDashboard.useMemo[inventoryCategoryOptions]"], [
        inventoryItems
    ]);
    const businessCategoryOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[businessCategoryOptions]": ()=>uniqueSorted([
                ...inventoryItems.map({
                    "AdminDashboard.useMemo[businessCategoryOptions]": (item)=>item.category
                }["AdminDashboard.useMemo[businessCategoryOptions]"]),
                ...supplierRecords.map({
                    "AdminDashboard.useMemo[businessCategoryOptions]": (supplier)=>supplier.category
                }["AdminDashboard.useMemo[businessCategoryOptions]"]),
                ...expenseRecords.map({
                    "AdminDashboard.useMemo[businessCategoryOptions]": (expense)=>expense.category
                }["AdminDashboard.useMemo[businessCategoryOptions]"])
            ])
    }["AdminDashboard.useMemo[businessCategoryOptions]"], [
        expenseRecords,
    ...
    const inventoryItemNameOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[inventoryItemNameOptions]": ()=>uniqueSorted([
                ...inventoryItems.map({
                    "AdminDashboard.useMemo[inventoryItemNameOptions]": (item)=>item.name
                }["AdminDashboard.useMemo[inventoryItemNameOptions]"]),
                ...purchaseRecords.map({
                    "AdminDashboard.useMemo[inventoryItemNameOptions]": (purchase)=>purchase.name
                }["AdminDashboard.useMemo[inventoryItemNameOptions]"])
            ])
    }["AdminDashboard.useMemo[inventoryItemNameOptions]"], [
        inventoryItems,
    ...
    const supplierNameOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[supplierNameOptions]": ()=>uniqueSorted([
                ...supplierRecords.map({
                    "AdminDashboard.useMemo[supplierNameOptions]": (supplier)=>supplier.name
                }["AdminDashboard.useMemo[supplierNameOptions]"]),
                ...inventoryItems.map({
                    "AdminDashboard.useMemo[supplierNameOptions]": (item)=>item.supplier
                }["AdminDashboard.useMemo[supplierNameOptions]"]),
                ...purchaseRecords.map({
                    "AdminDashboard.useMemo[supplierNameOptions]": (purchase)=>purchase.category
                }["AdminDashboard.useMemo[supplierNameOptions]"])
            ])
    }["AdminDashboard.useMemo[supplierNameOptions]"], [
        inventoryItems,
    ...
    const expenseCategoryOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminDashboard.useMemo[expenseCategoryOptions]": ()=>uniqueSorted(expenseRecords.map({
                "AdminDashboard.useMemo[expenseCategoryOptions]": (expense)=>expense.category
            }["AdminDashboard.useMemo[expenseCategoryOptions]"]))
    }["AdminDashboard.useMemo[expenseCategoryOptions]"], [
        expenseRecords
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            if (!visibleNavItems.some({
                "AdminDashboard.useEffect": (item)=>item.key === active
            }["AdminDashboard.useEffect"])) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminDashboard.useEffect": ()=>{
            ...
            async function loadInventory() {
                ...
                const { data, error } = await supabase.from("inventory_items").select("id,name,category,unit,price,cost_price,stock,threshold,supplier,is_service").eq("active", true).order("name", {
                    ascending: true
                });
                if (ignore) {
                    return;
                ...
                const [suppliersResult, purchasesResult, expensesResult, quotesResult, customersResult, salesResult, profilesResult, settingsResult] = await Promise.all([
                    ...
                    supabase.from("sales").select("id,sale_ref,customer_name,customer_phone,payment_method,status,total,amount_paid,discount,notes,created_at,active,sale_items(id,item_name,quantity,unit_price,unit_cost)").eq("active", true).order("created_at", {
                        ascending: false
                    }),
                ...
                if (quotesResult.data) {
                    ...
                    setQuoteRecords(quoteRows.map({
                        "AdminDashboard.useEffect.loadInventory": (row, index)=>{
    ...
    async function saveInventoryItem() {
        ...
        const query = editingItem ? supabase.from("inventory_items").update(payload).eq("id", editingItem.id).select("id,name,category,unit,price,cost_price,stock,threshold,supplier,is_service").single() : supabase.from("inventory_items").insert(payload).select("id,name,category,unit,price,cost_price,stock,threshold,supplier,is_service").single();
    ...
    function openManagedEditor(kind, itemId) {
        ...
        if (kind === "supplier") {
            ...
            setManagedEditor({
                ...
                fields: supplierToFields(supplier, businessCategoryOptions)
            });
        }
        if (kind === "purchase") {
            ...
            setManagedEditor({
                ...
                fields: purchaseToFields(purchase, inventoryItemNameOptions, supplierNameOptions)
            });
        }
        if (kind === "expense") {
            ...
            setManagedEditor({
                ...
                fields: expenseToFields(expense, expenseCategoryOptions)
            });
        }
        if (kind === "quote") {
            ...
            setManagedEditor({
                ...
                fields: quoteToFields(quote, inventoryItemNameOptions)
            });
        }
        if (kind === "customer") {
    ...
    async function saveManagedRecord() {
        ...
        try {
            ...
            if (managedEditor.kind === "quote") {
                const existingQuote = managedEditor.itemId ? quoteRecords.find((entry)=>entry.id === managedEditor.itemId) : undefined;
                const quote = {
    ...
    async function updateInventoryStock(itemId, nextStock) {
        ...
        const { data, error } = await supabase.from("inventory_items").update({
            stock
        }).eq("id", itemId).select("id,name,category,unit,price,cost_price,stock,threshold,supplier,is_service").single();
        if (error) {
            throw error;
        }
    ...
    async function updateInventoryCostByItemName(itemName, nextCostPrice) {
        ...
        if (isDemo) {
            setInventoryItems((current)=>{
                const next = current.map((entry)=>entry.id === item.id ? {
                        ...entry,
                        costPrice
                    } : entry);
                writeStoredDemoInventory(next);
        ...
        }).eq("id", item.id).select("id,name,category,unit,price,cost_price,stock,threshold,supplier,is_service").single();
        if (error) {
            throw error;
        }
        setInventoryItems((current)=>current.map((entry)=>entry.id === item.id ? inventoryRowToItem(data) : entry));
    }
    async function restoreInventoryForDeletedSale(sale) {
        ...
        for (const line of sale.items){
            ...
            const inventoryItem = inventoryItems.find((entry)=>entry.id === line.id) ?? inventoryItems.find((entry)=>sameItemName(entry.name, line.name));
            if (!inventoryItem || inventoryItem.isService) {
                continue;
            }
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: visibleNavItems.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: item.key,
                                            children: item.label
                                        }, item.key, false, {
                                            fileName: "[project]/src/app/admin/dashboard.tsx",
                    ...
                    isAdmin && active === "dashboard" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DashboardOverview, {
                    ...
                    isAdmin && active === "reports" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ReportsPanel, {
                        inventoryItems: filteredInventoryItems,
                    ...
                    isAdmin && active === "staff" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StaffPanel, {
                    ...
                    isAdmin && active === "settings" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SettingsPanel, {
            ...
            quoteEditorOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(QuoteCartEditor, {
...
_s(AdminDashboard, "/g0FS+JQKEm5ajVkASzoJXYkYXY=");
_c = AdminDashboard;
function DashboardOverview({ revenue, profit, margin, lowStockCount, sales, salesCount, discount, period, onPeriodChange, pendingQuotesCount, onNewSale, onAddStock, onCreateQuote, onReprintReceipt }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MetricCard, {
                icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$badge$2d$dollar$2d$sign$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BadgeDollarSign$3e$__["BadgeDollarSign"],
                label: "Gross profit",
                value: revenue > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(profit) : "—",
                tone: "green"
            }, void 0, false, {
                fileName: "[project]/src/app/admin/dashboard.tsx",
                lineNumber: 2378,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MetricCard, {
                icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$badge$2d$dollar$2d$sign$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BadgeDollarSign$3e$__["BadgeDollarSign"],
                label: "Profit margin",
                value: revenue > 0 ? formatPercent(margin) : "—",
                tone: "blue"
            }, void 0, false, {
                fileName: "[project]/src/app/admin/dashboard.tsx",
                lineNumber: 2379,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                    children: [
                                                        "-",
                                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(0)
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/src/app/admin/dashboard.tsx",
                                                    lineNumber: 2732,
                    ...
                    children: sales.map((sale)=>{
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                    "data-label": "Profit",
                                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(profit)
                                }, void 0, false, {
                                    fileName: "[project]/src/app/admin/dashboard.tsx",
                                    lineNumber: 2827,
                                    columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: [
                                            "Cost ",
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(item.costPrice)
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/admin/dashboard.tsx",
                                        lineNumber: 2899,
...
_c7 = InventoryPanel;
function InventoryEditor({ form, title, pending, categoryOptions, onChange, onCancel, onSave }) {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                            children: [
                                ...
                                categoryOptions.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("datalist", {
...
function SuppliersPanel({ rows, onAdd, onEdit, onDelete }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SimpleList, {
        ...
        rows: listRows,
        onAdd: onAdd,
        onEdit: onEdit ? (row)=>onEdit(row.raw) : undefined,
        onDelete: onDelete ? (row)=>onDelete(row.raw) : undefined
    }, void 0, false, {
        fileName: "[project]/src/app/admin/dashboard.tsx",
        lineNumber: 3044,
        columnNumber: 10
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: [
                                            ...
                                            quote.totalAmount > 0 ? ` · ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(quote.totalAmount)}` : ""
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/admin/dashboard.tsx",
                                        lineNumber: 3138,
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "card-actions",
                                        children: onEdit || onDelete ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RowActions, {
...
function ReportsPanel({ inventoryItems, salesRecords, expenseRecords, customerRecords, staffRecords }) {
    ...
    const inventoryCostValue = inventoryItems.filter((item)=>!item.isService).reduce((sum, item)=>sum + item.costPrice * item.stock, 0);
    const inventorySellingValue = inventoryItems.filter((item)=>!item.isService).reduce((sum, item)=>sum + item.price * item.stock, 0);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MetricCard, {
                        ...
                        value: inventoryCostValue > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(inventoryCostValue) : "—",
                        tone: "green"
                    }, void 0, false, {
                        fileName: "[project]/src/app/admin/dashboard.tsx",
                        lineNumber: 3356,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MetricCard, {
                        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$badge$2d$dollar$2d$sign$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BadgeDollarSign$3e$__["BadgeDollarSign"],
                        label: "Gross profit",
                        value: salesAmount > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(grossProfit) : "—",
                        tone: "green"
                    }, void 0, false, {
                        fileName: "[project]/src/app/admin/dashboard.tsx",
                        lineNumber: 3358,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MetricCard, {
                        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$badge$2d$dollar$2d$sign$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BadgeDollarSign$3e$__["BadgeDollarSign"],
                        label: "Profit margin",
                        value: salesAmount > 0 ? formatPercent(grossMargin) : "—",
                        tone: "blue"
                    }, void 0, false, {
                        fileName: "[project]/src/app/admin/dashboard.tsx",
                        lineNumber: 3359,
                            ...
                            children: [
                                ...
                                field.type === "select" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        ...
                                        field.suggestions?.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("datalist", {
                                            id: `managed-${editor.kind}-${field.name}-options`,
                                            children: field.suggestions.map((suggestion)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: suggestion
                                                }, suggestion, false, {
                                                    fileName: "[project]/src/app/admin/dashboard.tsx",
                                                    lineNumber: 3568,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    children: quoteRows.map((item, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    children: index + 1
                                                }, void 0, false, {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    children: item.price > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(item.price) : ""
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/dashboard.tsx",
                                                    lineNumber: 3680,
                                                    columnNumber: 19
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    children: item.price > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(item.price * item.quantity) : ""
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/dashboard.tsx",
                                                    lineNumber: 3681,
                                                    columnNumber: 19
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("em", {
                                                    children: quote.totalAmount > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(quote.totalAmount) : ""
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/dashboard.tsx",
                                                    lineNumber: 3693,
                                                    columnNumber: 46
...
_s2(QuotePrintModal, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c20 = QuotePrintModal;
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("em", {
                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(summary.salesCost)
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/dashboard.tsx",
                                            lineNumber: 3794,
                                            columnNumber: 56
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("em", {
                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(summary.grossProfit)
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/dashboard.tsx",
                                            lineNumber: 3795,
                                            columnNumber: 50
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("em", {
                                            children: formatPercent(summary.grossMargin)
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/dashboard.tsx",
                                            lineNumber: 3796,
                                            columnNumber: 51
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("em", {
                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(summary.inventoryCostValue)
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/dashboard.tsx",
                                            lineNumber: 3797,
                                            columnNumber: 58
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                            children: "Inventory selling value"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/dashboard.tsx",
                                            lineNumber: 3798,
                                            columnNumber: 21
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("em", {
                                            children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(summary.inventorySellingValue)
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/admin/dashboard.tsx",
                                            lineNumber: 3798,
                                            columnNumber: 61
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ReportTable, {
                                    ...
                                    rows: summary.sales.map((sale)=>[
                                            ...
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(saleCost(sale)),
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(saleProfit(sale)),
                                            ...
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$currency$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatGhs"])(Math.max(saleTotal(sale) - sale.paid, 0))
                                        ])
                                }, void 0, false, {
                                    fileName: "[project]/src/app/admin/dashboard.tsx",
                                    lineNumber: 3819,
...
_s3(ReportPrintModal, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c21 = ReportPrintModal;
...
_s4(ReceiptModal, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c23 = ReceiptModal;
...
__turbopack_context__.k.register(_c4, "QuoteCartEditor");
__turbopack_context__.k.register(_c5, "SalesPanel");
__turbopack_context__.k.register(_c6, "ResponsiveSalesTable");
__turbopack_context__.k.register(_c7, "InventoryPanel");
__turbopack_context__.k.register(_c8, "InventoryEditor");
__turbopack_context__.k.register(_c9, "SuppliersPanel");
__turbopack_context__.k.register(_c10, "PurchasesPanel");
__turbopack_context__.k.register(_c11, "ExpensesPanel");
__turbopack_context__.k.register(_c12, "QuotesPanel");
__turbopack_context__.k.register(_c13, "CustomersPanel");
__turbopack_context__.k.register(_c14, "ReportsPanel");
__turbopack_context__.k.register(_c15, "StaffPanel");
__turbopack_context__.k.register(_c16, "SettingsPanel");
__turbopack_context__.k.register(_c17, "SimpleList");
__turbopack_context__.k.register(_c18, "RowActions");
__turbopack_context__.k.register(_c19, "ManagedEditor");
__turbopack_context__.k.register(_c20, "QuotePrintModal");
__turbopack_context__.k.register(_c21, "ReportPrintModal");
__turbopack_context__.k.register(_c22, "ReportTable");
__turbopack_context__.k.register(_c23, "ReceiptModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
